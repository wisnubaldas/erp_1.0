 ...
 function list_inquiry()
	{
		...
		foreach ($list as $datalist){
			...
			'Status' =>$datalist->CreatedDate=='Prospect'?'<span class="uk-badge uk-badge-warning">No Customer</span>':'<span class="uk-badge uk-badge-primary">Robert</span>',
			...
			'action' =>'<div class="uk-button-dropdown" data-uk-dropdown>
                                ...
                                <div class="uk-dropdown uk-dropdown-small">
                                    <ul class="uk-nav uk-nav-dropdown">
                                        <li><a href="'.site_url('logistic/Inquiry/manage_inquiry').'"><i class="material-icons">description</i>Manage Quotation</a></li>
