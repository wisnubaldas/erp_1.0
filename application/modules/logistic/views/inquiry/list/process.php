 ...
 $(document).ready(function() {    
          ...
          tbl_proses = $('.tbl_proses').DataTable({ 
...
$('.tbl_proses tbody').on('click', 'tr', function () {
            var tr = $(this).closest('tr');
            var row = tbl_proses.row(tr);
...
function reload_tbl_proses()
    {
      tbl_proses.ajax.reload(null,false); //reload datatable ajax 
    }

  </script>

<table id="tbl_prosesyyyyy" class="uk-table hover tbl_proses" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                              <th width="2%">No</th>
                                <th width="2%">No</th>
