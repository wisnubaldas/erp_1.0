 ...
 "lengthMenu": [[25, 50, 75, -1], [25, 50, 75, "All"]],
            ...
            "ajax": {
                "url": "<?php echo site_url('logistic/Preshipment/list_preshipment')?>",
                "type": "POST",
            },
            "columns": [
...
// Redirect if click
window.location.href = "<?php echo base_url();?>logistic/Preshipment/preshipment_detail/"+row.data().id_header;
			//sidebarNonAktif();
