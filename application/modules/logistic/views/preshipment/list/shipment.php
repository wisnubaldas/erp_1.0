 ...
 $(document).ready(function() {    
          ...
          tbl_shipment = $('.tbl_shipment').DataTable({ 
...
$('.tbl_shipment tbody').on('click', 'tr', function () {
            var tr = $(this).closest('tr');
            var row = tbl_shipment.row(tr);
...
function reload_tbl_shipment()
    {
      tbl_shipment.ajax.reload(null,false); //reload datatable ajax 
    }

  </script>

<table id="tbl_shipmentyyyyy" class="uk-table hover tbl_shipment" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                              <th width="2%">No</th>
                                <th width="2%">No</th>
