 ...
 $(document).ready(function() {    
          ...
          tbl_cancel = $('.tbl_cancel').DataTable({ 
...
$('.tbl_cancel tbody').on('click', 'tr', function () {
            var tr = $(this).closest('tr');
            var row = tbl_cancel.row(tr);
...
function reload_tbl_cancel()
    {
      tbl_cancel.ajax.reload(null,false); //reload datatable ajax 
    }

  </script>

<table id="tbl_cancelyyyyy" class="uk-table hover tbl_cancel" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                              <th width="2%">No</th>
                                <th width="2%">No</th>
