...
//-- for 2 choosen ---///////////////////////////////////////////
	function get_datatables2($selected,$nm_tabel,$nm_coloum,$orderby,$where,$nm_tabel2,$kolom1,$kolom2)
	{
		...
		$this->db->join("mscountry c",'a.IdCouOri=c.Id','LEFT');
		$this->db->join("mscity d",'a.IdCityOri=d.Id','LEFT');
		$this->db->join("msport e",'a.IdPortOri=e.Id','LEFT');
		$this->db->join("mscountry f",'a.IdCouDest=f.Id','LEFT');
		$this->db->join("mscity g",'a.IdCityDest=g.Id','LEFT');
		...
		$this->db->join("trinquiry_stage k",'a.Id=k.IdInquiry','LEFT');
		$this->db->join("msinquiry_stage l",'k.IdInqStage=l.Id','LEFT');
...
//=====================login member cek============================
	...
	$query=$this->db->query("select*from ".$table." where Email='$username' and Password='$password'");		
	return $query->result();
    }
