...
<div class="uk-width-medium-8-10">
    ...
    <div class="md-card">
        ...
        <div class="md-card-content" style="min-height:600px" id="box-content-cust">
            ...
            <?php echo $this->load->view('customer/general');?>
