	...
	swal({
		...
		html:true
             ...
             // alert('hai' + idcnote);
				$.ajax({
                type: "POST",
                url : "<?php echo base_url('customer/Customer/saveGeneral'); ?>",
...
$('#countryfield').combogrid({
            ...
            mode       : 'remote',
            loadMsg    : 'search',
			url        : '<?php echo base_url(); ?>customer/Customer/getCountry',
			columns    : [[
...
$('#cityfield').combogrid({
            ...
            mode       : 'remote',
            loadMsg    : 'search',
			url        : '<?php echo base_url(); ?>customer/Customer/getCity',
			columns    : [[
...
function saveGeneral()
	...
	swal({
        ...
        url = "<?php echo site_url('customer/Customer/saveGeneral')?>";
