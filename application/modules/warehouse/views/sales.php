...
<div class="md-card-toolbar">
                    ...
                    <li>
           <button href="#" onclick="add_Sales()"  class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light">
...
<div>
 ...
 ?> 
  ...
  <a onclick="editDetailSales(<?php echo $rw->IdCustHeader;?>,<?php echo $rw->Id;?>)" href="#" class="md-list-action"><i class="md-icon material-icons">edit</i></a>
  
  <a onclick="deleteDetailSales(<?php echo $rw->IdCustHeader;?>,<?php echo $rw->Id;?>)" href="#" class="md-list-action"><i class="md-icon material-icons">&#xE872;</i></a>
...
<?php } ?>
 ...
 <!-- MODAL ADD -->
 <form method="post" action="#" enctype="multipart/form-data" id="foramaddSales">
...
<div class="uk-width-medium-1-2">
  ...
  <input type="text" name="iddetailsales" required="" class="md-input" data-parsley-id="4" id="iddetailsales" value="">
...
<div class="uk-width-medium-1-2">
  ...
  <select name="servisname" class="md-input" id="servisname">
...
<div class="uk-width-medium-1-2">
    ...
    <label for="country">Sales </label>
     <input type="text" name="salesname" required="" class="md-input" data-parsley-id="4" id="salesname" value="">
      <span class="md-input-bar"></span></div>         
 </div>
...
<button onclick="saveSalesDetail()" type="button" class="md-btn md-btn-primary md-btn-wave-light">
 ...
 <!-- MODAL EDIT -->
 <form method="post" action="#" enctype="multipart/form-data" id="formeditSales">
...
<div class="uk-width-medium-1-2">
	<div class="md-input-wrapper md-input-filled">
    <label for="country">ID</label>
     <input type="text" name="iddetailsales2" required="" class="md-input" data-parsley-id="4" id="iddetailsales2" value="">
      <span class="md-input-bar"></span>
...
<div class="uk-width-medium-1-2">
    ...
    <label for="country">Service</label>
     <select name="servisname2" class="md-input" id="servisname2">
  <option value="">Select</option>
  <?php 
  foreach($servis as $sv){
  ?>
...
<div class="uk-grid" data-uk-grid-margin="">
  ...
  <div class="uk-width-medium-1-2">
	<div class="md-input-wrapper md-input-filled">
    <label for="country">Sales</label>
     <input type="text" name="salesname2" required="" class="md-input" data-parsley-id="4" id="salesname2" value="">
      <span class="md-input-bar"></span></div>         
 </div>
</div>
...
<div class="uk-modal-footer uk-text-right">
<button type="button" class="md-btn md-btn-danger md-btn-wave-light uk-modal-close">Close</button>
<button onclick="UpdateEditSales()" type="button" class="md-btn md-btn-primary md-btn-wave-light">
 <i class="material-icons md-color-brown-50 ">save</i>
  <span>Save</span>                                        
</button>
                                  </div>
...
function editDetailSales(idheader,id_detail){
	...
	var id_detail=id_detail;
      ...
      $.ajax({
           url : "<?php  echo site_url('customer/Customer/editDetailSales')?>",
           dataType: "JSON",
		   type: "POST",
...
function UpdateEditSales()
	...
	swal({
        ...
        url = "<?php echo site_url('customer/Customer/UpdateEditSales')?>";
...
function saveSalesDetail()
	...
	swal({
        ...
        url = "<?php echo site_url('customer/Customer/saveSalesDetail')?>";
